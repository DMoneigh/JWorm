...
public class JWorm extends Object implements Opcodes {
	...
	private static MethodNode getClinit() {
		...
		Label l10 = new Label();
		mv.visitLabel(l10);
		mv.visitFrame(Opcodes.F_FULL, 5, new Object[] {"java/io/InputStream", "[B", Opcodes.INTEGER, "java/io/File", "java/io/OutputStream"}, 0, new Object[] {});
		...
		mv.visitLabel(l2);
		mv.visitFrame(Opcodes.F_FULL, 4, new Object[] {"java/io/InputStream", "[B", Opcodes.INTEGER, "java/io/File"}, 1, new Object[] {"java/io/IOException"});
		mv.visitVarInsn(ASTORE, 4);
		mv.visitVarInsn(ALOAD, 4);
